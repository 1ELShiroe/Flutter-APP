...
class NextFilms extends StatefulWidget {
  const NextFilms({Key? key}) : super(key: key);

  @override
  State<NextFilms> createState() => _NextFilmsState();
}

class _NextFilmsState extends State<NextFilms> {
